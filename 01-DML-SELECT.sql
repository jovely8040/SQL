...
-- 내림차순: 큰 값 -> 작은 값 (DESC) 기본 값이 아니므로 반드시 명시
...
SELECT SYSDATE FROM employees; -- employees의 레코드 갯수만큼
...
-- IT 관련 직원에게는 8%,
-- 나머지는 5%
SELECT first_name, job_id, salary, SUBSTR(job_id, 1, 2), -- 첫번째 글자부터 두글자 뜯어내
